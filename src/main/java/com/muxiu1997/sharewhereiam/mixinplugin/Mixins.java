...
import com.muxiu1997.sharewhereiam.ShareWhereIAm;
...
public enum Mixins {
    ...
    public static List<String> getEarlyMixins(Set<String> loadedCoreMods) {
        ...
        ShareWhereIAm.logger.info("Not loading the following EARLY mixins: {}", notLoading);
        return mixins;
    }
    ...
    public static List<String> getLateMixins(Set<String> loadedMods) {
        ...
        ShareWhereIAm.logger.info("Not loading the following LATE mixins: {}", notLoading.toString());
        return mixins;
    }
